...
/// This trait defines a schemadb: an association of a column family name, the key type and the value
/// type.
...
#[cfg(feature = "fuzzing")]
pub mod fuzzing {
    use crate::schemadb::{KeyCodec, Schema, ValueCodec};
    ...
    /// Helper used in tests and fuzzers to make sure a schemadb never panics when decoding random bytes.
